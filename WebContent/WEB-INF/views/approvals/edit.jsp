    ...
    <c:param name="content">
        ...
        <c:choose>
            <c:when test="${report != null}">
                ...
                <input type="date" name="approved_date" value="<fmt:formatDate value='${report.approved_date}' pattern='yyyy-MM-dd' />">
                <br /><br />

                <label for="approval_result">承認結果</label><br />
                <select name="approval_result">
                    <option value="0"<c:if test="${approval.approval_result == 0}"> selected</c:if>>未承認</option>
                ...
                <textarea name="approval_comment" rows="5" cols="50">${report.approval_comment}</textarea>
                <br /><br />
                </form>
